...
const achievements: Achievement[] = [
  ...
  {
    title: 'Меморандумы и партнерские договоренности',
    description:
...
const projects = [
  {
    ...
    description: 'Создание национального контура вычислительных мощностей для ИИ-проектов и прикладных исследований.',
    icon: Server,
    progress: 35,
  },
  {
    title: 'Партнерское финансирование',
    status: 'Подготовка запуска в 2026',
    description: 'Программа капитализации инноваций и формирования отраслевого инвестиционного фонда.',
    icon: Users,
    progress: 60,
  },
  {
    ...
    description: 'Крупнейшая региональная площадка по конвергентным технологиям для экспертов и инвесторов.',
    icon: Globe,
    progress: 20,
  },
  {
    ...
    status: 'MVP-проект',
    description: 'Единая среда для коммуникаций членов Ассоциации, партнеров, стартапов и экспертных групп.',
    icon: Rocket,
    progress: 45,
  },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold text-[#F3F4E9] font-bebas tracking-tight">
            Реальные шаги
            <br />
            <span className="text-[#5F891D]">в развитии экосистемы</span>
          </h2>
        </motion.div>
