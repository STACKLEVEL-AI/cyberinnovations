...
const challenges: Challenge[] = [
  {
    title: 'Технологический суверенитет и инфраструктурная независимость',
    shortDesc:
      'Мы создаем доступную базу вычислительных мощностей для масштабирования национальных ИИ-проектов. Выступая мостом между государством и бизнесом, Ассоциация превращает геополитические риски в фундамент для цифрового прорыва и роста реального сектора экономики.',
    fullDesc:
  ...
  },
  {
    ...
    shortDesc:
      'Технологии эффективны лишь в руках профессионалов. Мы формируем среду, где развитие талантов и внедрение управленческих стандартов опережают запросы рынка. Наш приоритет — ликвидация кадрового дефицита для реализации ИТ-проектов национального масштаба.',
    fullDesc:
  ...
  },
  {
    ...
    shortDesc:
      'Мы трансформируем сервисную ИТ-модель в продуктовую, консолидируя стартапы и разработки внутри страны. Обеспечивая прямой доступ к государственному и промышленному секторам для апробации решений, Ассоциация создает условия для капитализации талантов в Беларуси.',
    fullDesc:
  ...
  },
  {
    ...
    shortDesc:
      'Мы выступаем точкой сборки капитала для развития сквозных технологий и регуляторных инициатив. Наша цель — обеспечить белорусские продукты ресурсами на ранних стадиях и создать базу для их глобального масштабирования, сохраняя выгоды внутри национальной экономики.',
    fullDesc:
  ...
  },
  {
    ...
    shortDesc:
      'Ассоциация устраняет барьеры между отраслями, предлагая модель сотрудничества без бюрократии. Мы синхронизируем интересы частного бизнеса с государственными приоритетами, создавая защищенную и устойчивую инфраструктуру для реализации сложнейших технологических вызовов страны.',
    fullDesc:
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-end">
            ...
            <p className="text-base lg:text-lg text-[#151515]/70 leading-relaxed max-w-xl">
              Пять стратегических контуров, которые Ассоциация превращает в практические инициативы для экономики
              Республики Беларусь.
            </p>
          </div>
        </motion.div>
