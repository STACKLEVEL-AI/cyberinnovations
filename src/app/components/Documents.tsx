...
const documents: Document[] = [
  {
    ...
    description: 'Цели, структура и принципы работы Ассоциации',
    icon: BookOpen,
  ...
  },
  {
    ...
    description: 'Условия и порядок вступления для юридических лиц',
    icon: FileCheck,
    size: 'публикация готовится',
    available: false,
  },
...
const membershipSteps = [
  {
    ...
    description: 'Изучите миссию, направления и формат участия в Ассоциации.',
  },
  {
    step: '02',
  ...
  },
  {
    ...
    description: 'Профильная группа анализирует заявку и формирует предложение по взаимодействию.',
  },
  {
    step: '04',
    title: 'Подключение к экосистеме',
    description: 'Согласование формата сотрудничества и запуск совместной работы.',
  },
];
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-[#F3F4E9]/62 leading-relaxed mb-8">
                  Выберите роль и отправьте запрос. Мы поможем подключиться к треку, который соответствует вашим задачам.
                </p>

                <div className="space-y-4">
                  {[
                    'Членство для технологических компаний',
                    'Экспертные запросы от госорганов и партнеров',
