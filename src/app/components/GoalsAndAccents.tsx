...
const goals = [
  'Показать направления, подкомитеты, проекты и форматы работы Ассоциации.',
  'Дать понятные сценарии взаимодействия для государства и бизнеса.',
  'Открыть доступ к инициативам: пилоты, рабочие группы, мероприятия, инфраструктура.',
  'Усилить доверие через партнёрства, документы и публичные результаты.',
];

const accents = [
  'За 10 секунд должно быть ясно: **какую задачу Ассоциация решает** и **чем полезна вам**. ([Nielsen Norman Group][1])',
  'Дальше — выбираете роль и **отправляете заявку** на конкретное действие.',
];
...
const roleAccents: RoleAccent[] = [
  ...
  },
  {
    ...
    action: 'Подпишитесь на новости и анонсы, чтобы получать обновления по проектам и результатам.',
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-[#151515]/70 leading-relaxed max-w-4xl">
            Быстро понять, чем занимается Ассоциация, выбрать свою роль и отправить целевой запрос: членство, партнёрство, экспертиза или участие в проектах.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="rounded-xl bg-white/5 border border-white/10 p-4">
              <p className="text-sm text-[#F3F4E9]/70">
                Выберите роль — откроется форма заявки с нужным типом обращения. Мы вернёмся с предложением формата взаимодействия и следующими шагами.
              </p>
            </div>
          </motion.div>
        </div>
