...
const keyPoints = [
  {
    value: '$200+ млн',
    label: 'Целевой объём отраслевого фонда для поддержки стартапов и масштабирования технологических проектов.',
    icon: DollarSign,
  },
  {
    value: '7',
    label: 'Технологических подкомитетов — рабочие группы, где собираем требования, экспертизу и проекты по ключевым направлениям.',
    icon: Cpu,
  },
  {
    value: 'Гос-во + Бизнес + Наука',
    label: 'Единый контур координации инновационной политики: от запроса и экспертизы — до внедрения и оценки эффекта.',
    icon: Building2,
  },
];
        ...
        <div className="max-w-5xl">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-[#F3F4E9] mb-8 font-bebas leading-[0.95] tracking-tight max-w-5xl">
              Ассоциация цифровых технологий и инноваций
              <br />
            ...
            <p className="text-base md:text-xl text-[#F3F4E9]/80 mb-10 leading-relaxed max-w-4xl">
              Единая платформа взаимодействия государства, бизнеса и науки: формируем повестку и стандарты, запускаем пилоты, развиваем инфраструктуру и инвестиции для внедрения конвергентных технологий в экономику Беларуси.
            </p>
