...
const committeeMeta: Record<
  CommitteeKey,
  { title: string; badge: string; icon: React.ElementType; accent: string; image: string }
> = {
  ai: {
    ...
    icon: Brain,
    accent: '#5F68A5',
    image: withBasePath('/materials/hero/ai.jpg'),
  },
  blockchain: {
    ...
    icon: Link,
    accent: '#5F891D',
    image: withBasePath('/materials/hero/blockchain.jpg'),
  },
  iot: {
    ...
    icon: Radio,
    accent: '#5F891D',
    image: withBasePath('/materials/hero/iot.jpg'),
  },
  cybersecurity: {
    ...
    icon: Shield,
    accent: '#5F68A5',
    image: withBasePath('/materials/hero/cybersecurity.jpg'),
  },
  microelectronics: {
    ...
    icon: Cpu,
    accent: '#5F68A5',
    image: withBasePath('/materials/hero/microelectronics.jpg'),
  },
  cloud: {
    ...
    icon: Cloud,
    accent: '#5F891D',
    image: withBasePath('/materials/hero/cloud.jpg'),
  },
  energy: {
    ...
    icon: Zap,
    accent: '#5F891D',
    image: withBasePath('/materials/hero/energy.jpg'),
  },
  'human-capital': {
    ...
    icon: Users,
    accent: '#5F68A5',
    image: withBasePath('/materials/hero/human-capital.jpg'),
  },
};
