...
const priorities2026: Priority[] = [
  {
    ...
    description:
      'Запуск программы партнерского финансирования и создание отраслевого фонда с целевым объемом $200+ млн для поддержки более 20 национальных стартапов.',
    metric: '$200+ млн',
  },
  {
    icon: Server,
    ...
    description:
      'Создание Belarus AI Data Center под эгидой Ассоциации — площадки, предоставляющей членам доступ к мощностям для собственных разработок и привлечения масштабных международных проектов.',
    highlight: true,
  },
  {
    icon: Globe,
    ...
    description:
      'Организация крупнейшей в регионе международной конференции по конвергентным технологиям как ключевой точки сборки для мировых экспертов и инвесторов.',
    metric: '2026',
  },
];
...
const priorities2030: Priority[] = [
  {
    ...
    description: 'Формирование системы, обеспечивающей стабильный приток инвестиций в национальные проекты на уровне $300+ млн ежегодно.',
    metric: '$300+ млн/год',
  },
  {
    icon: RocketIcon,
    ...
    description:
      'Создание комплексной IT-инфраструктуры, способной генерировать и выводить на мировой уровень не менее 5 компаний-единорогов в год.',
  ...
  },
  {
    ...
    description:
      'Формирование условий для непрерывного притока высококвалифицированных кадров во все регионы страны и превращение областных центров в точки технологического роста.',
  },
  {
    icon: Factory,
    title: 'Цикл сверхбыстрого масштабирования',
    description:
      'Запуск бесшовной цепочки разработки, при которой инновации проходят путь от идеи и тестирования на внутреннем рынке до глобальной экспансии менее чем за один год.',
    metric: '< 1 года',
  },
];
