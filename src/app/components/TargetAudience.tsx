...
const partners: Partner[] = [
  { name: 'BRICS Pay', logo: withBasePath('/materials/partners/brics-pay.svg') },
  { name: 'НЦОД', logo: withBasePath('/materials/partners/ncod.svg') },
  { name: 'СБХ', logo: withBasePath('/materials/partners/sbh.svg') },
  { name: 'АУРВА', logo: withBasePath('/materials/partners/aurva.svg') },
  { name: 'Бел. ТПП', logo: withBasePath('/materials/partners/bel-tpp.svg') },
  { name: 'ПЛАС', logo: withBasePath('/materials/partners/plas.svg') },
  { name: 'БелВЭБ', logo: withBasePath('/materials/partners/belveb.svg') },
  { name: 'ПВТ', logo: withBasePath('/materials/partners/pvt.svg') },
  { name: 'BYCLOUD', logo: withBasePath('/materials/partners/bycloud.svg') },
];
