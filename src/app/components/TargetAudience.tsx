...
const audiences: AudienceGroup[] = [
  {
    ...
    benefits: [
      'Коллективная экспертиза: прямой доступ к пулу экспертов для разработки нормативных актов и регуляторных инициатив.',
      'Витрина решений: доступ к зрелым проектам членов Ассоциации для внедрения в государственную инфраструктуру.',
      'Координационный центр: синхронизация целей бизнеса, науки и государства в рамках госпрограмм инновационного развития.',
      'Международное представительство: единый канал трансляции компетенций белорусского IT-сектора на международных площадках.',
    ],
    color: '#5F68A5',
  },
  {
    ...
    benefits: [
      'Коммерциализация R&D: связь с бизнесом и инвесторами для внедрения академических исследований в реальные цепочки.',
      'Поддержка молодых ученых: система спонсорства и прямой контакт компаний с аспирантами и молодыми специалистами.',
      'Глобальный нетворкинг: содействие в заключении контрактов с зарубежными университетами и международными научными центрами.',
      'Совместные программы: участие в профильных проектах, где наука и индустрия работают в едином контуре.',
    ],
    color: '#5F891D',
  },
  {
    ...
    benefits: [
      'GR-инструменты: участие в формировании государственной политики в сфере цифровых технологий.',
      'Государственный заказ: доступ к проектам национального масштаба для внедрения собственных решений.',
      'Привлечение капитала: выход к партнерскому финансированию Ассоциации и международным инвестиционным каналам.',
      'Глобальная экспансия: поддержка выхода на внешние рынки через международные связи и маркетинговые механики.',
    ],
    color: '#5F68A5',
  },
  {
    ...
    benefits: [
      'Инвестиционный лифт: представление белорусских стартапов крупнейшим фондам ближнего и дальнего зарубежья.',
      'Доступ к акселераторам: подключение к международным программам роста через сеть Ассоциации.',
      'Smart Money: менторство от опытных предпринимателей по найму, стратегии и масштабированию.',
      'Точки апробации: запуск пилотов и проверка гипотез внутри национальной экосистемы.',
    ],
    color: '#5F891D',
  },
  {
    ...
    benefits: [
      'Карьерный старт: стажировки в ведущих компаниях и участие в реальных проектах национального уровня.',
      'Профессиональное менторство: персональные консультации от лидеров отрасли по траектории развития.',
      'Публичное портфолио: участие в хакатонах, конкурсах и проектах открытого программного обеспечения.',
      'Мировой контекст: подключение к международным форумам, конференциям и профессиональным сообществам.',
    ],
    color: '#5F68A5',
  },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-[#151515]/70 leading-relaxed max-w-3xl">
            Создаём условия для устойчивого роста бизнеса через диалог с государством и совместную реализацию инициатив
            ...
            <div className="relative mt-4 lg:mt-0 lg:absolute lg:top-1/2 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 w-full lg:w-[350px]">
              <div className="rounded-3xl bg-[#151515] border border-white/10 p-6 md:p-8 text-center">
                ...
                <p className="text-sm text-[#F3F4E9]/70 leading-relaxed">
                  Платформа координации между государством, наукой и бизнесом, обеспечивающая реализацию инновационной
                  политики и развитие кадров.
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <p className="text-base md:text-lg text-[#F3F4E9]/80 leading-relaxed max-w-5xl">
            Ассоциация — надежный партнер для международного сотрудничества и место, где компании, исследователи и
            инвесторы создают новые продукты, масштабируют решения и формируют будущее экономики.
          </p>
        </motion.div>
