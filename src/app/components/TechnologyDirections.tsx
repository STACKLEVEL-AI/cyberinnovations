  ...
  return (
    <section className="py-24 relative overflow-hidden" id="directions">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-end">
            ...
            <p className="text-lg text-[#F3F4E9]/65 leading-relaxed max-w-lg">
              Подкомитеты Ассоциации — это рабочие контуры, где формируются требования, стандарты и проекты. Здесь государство и бизнес согласуют приоритеты и запускают внедрения по ключевым технологическим трекам.
            </p>
          </div>
        </motion.div>
        ...
        >
          <p className="text-sm text-[#F3F4E9]/40">Нажмите на карточку, чтобы увидеть задачи направления и способы подключения</p>
        </motion.div>
      </div>
    </section>
  );
